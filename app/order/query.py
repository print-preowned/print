...
from .model import Order, OrderCreateRequest, OrderUpdateRequest
import math
...
async def create_query(order: OrderCreateRequest):
...
async def update_query(id: str, order: OrderUpdateRequest):
...
async def read_query(params: ParamRequest) -> PaginatedData[Order]:
    ...
    return PaginatedData(
        data=[Order.model_validate(record) for record in records],
...
async def read_by_id_query(id: str) -> Order | None:
