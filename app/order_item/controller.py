...
@router.post("/create")
async def create(payload: OrderItemCreateRequest) -> Response:
    return await create_service(payload)


@router.put("/update/{id}")
async def update(id: str, payload: OrderItemUpdateRequest) -> Response:
...
async def read_by_id(id: str) -> BaseResponse[OrderItemRead]:
