...
router = APIRouter(prefix="/inventory-item", tags=["InventoryItemController"])


@router.post("/create")
async def create(payload: InventoryItemCreateRequest) -> Response:
    return await create_service(payload)


@router.put("/update/{id}")
async def update(id: str, payload: InventoryItemUpdateRequest) -> Response:
...
async def read_by_id(id: str) -> BaseResponse[InventoryItem]:
