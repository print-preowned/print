...
class VariantOptionService:
    ...
    async def read(self, params: PaginationParams) -> PaginatedResponse[ProductOptionValueRead]:
        total_results = await self._repo.count_product_option_values()
        rows = await self._repo.list_product_option_values(offset=params.offset, limit=params.size)
